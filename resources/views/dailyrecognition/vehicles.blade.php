<x-app-layout>
	...
	<div class=" flex items-center justify-between pb-6">
		<div>
			<h2 class="text-gray-600 font-semibold">Recognized Vehicles</h2>
			<span class="text-xs">Showing Daily Recognized Vehicles</span>
		</div>
						...
						<tbody>
							<tr>
								...
								<td class="flex px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <a href="{{ route('recognizedvehicle.show',$vehicle->id) }}">
                                    ...
                                    <form method="POST" action="{{ route('recognizedvehicle.destroy',$vehicle->id) }}">
                                        @csrf
                                        @method('DELETE')
                                        <a href="{{ route('recognizedvehicle.destroy',$vehicle->id) }}" onclick="event.preventDefault(); this.closest('form').submit();">
